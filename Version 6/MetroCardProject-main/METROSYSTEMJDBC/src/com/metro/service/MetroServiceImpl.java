...
public class MetroServiceImpl implements MetroService {
	...
	@Override
	public void hasBalance(int id) throws NotEnoughBalance, ClassNotFoundException, SQLException {
		if(metroDao.getBalance(id)<20) {
			throw new NotEnoughBalance("LOW BALANCE!");
		}
		
	}

	@Override
	public void isValidStation(int stationId) {
